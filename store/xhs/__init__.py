...
# Repository: https://github.com/webb-chen/webb-crawler/blob/main/store/xhs/__init__.py
...
async def update_xhs_note(note_item: Dict):
    ...
    local_db_item = {
        ...
        "last_modify_ts": utils.get_current_timestamp(),  # Last modification timestamp (Generated by webb-crawler, mainly used to record the latest update time of a record in DB storage)
